...
CREATE TABLE `resource_requests` (
  ...
  `type` enum('YouTube','Roadmap','GitHub') NOT NULL,
...
INSERT INTO `resource_requests` VALUES (2,1,'DSA in Hindi','YouTube','https://www.youtube.com/playlist?list=PLu0W_9lII9ahIappRPN0MCAgtOu3lQjQi'),(5,1,'DSA in Java','YouTube','https://youtube.com/playlist?list=PL9gnSGHSqcnr_DxHsP7AW9ftq0AtAyYqJ&si=A4FhH4gAbhkSQdIC');
